...
$string['shortnamesufixsingular'] = '(i {$a} altre)';
$string['showchildren'] = 'Mostra el fills';
$string['showchildrendesc'] = 'Voleu mostrar el cursos fills llistats sota el títol del curs principal?';
$string['showwelcomearea'] = 'Mostra l\'àrea de benvinguda';
$string['showwelcomeareadesc'] = 'Voleu mostrar l\'àrea de benvinguda a sobre de la llista de cursos?';
$string['view_edit_profile'] = '(Mostra i edita el teu perfil.)';
$string['welcome'] = 'Benvingut {$a}';
$string['youhavemessages'] = 'En teniu {$a} sense llegir';
$string['youhavenomessages'] = 'No teniu';
