<?php // $Id: category.php,v 1.119.2.16 2011/03/03 17:39:20 moodlerobot Exp $
...
/// Print the category selector
    ...
    //XTEC ************ AFEGIT - RSS link
	//2010.08.05
    $rsspix = $CFG->pixpath."/i/rss.gif";
    echo "<div class=\"category_rss\" style=\"float:right;margin-right:20px;\"><a href=\"$CFG->wwwroot/rss/category_rss.php?categoryid=$category->id\"><img src=\"$rsspix\"> RSS</a></div>";
    //************ FI
