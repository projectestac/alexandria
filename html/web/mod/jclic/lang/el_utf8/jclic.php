...
$string['jclicpluginjs']='Διεύθυνση του Web όπου μπορείτε να βρείτε το αρχείο <b>jclicplugin.js</b>';
...
$string['lap']='Χρόνος συναλλαγών μεταξύ client-server transactions (σε δευτερόλεπτα)';
$string['msg_nosessions']='Αυτή η δραστηριότητα του JClic δεν διαθέτει ακόμη καμία συνεδρία';
$string['show_results']='Προβολή αποτελεσμάτων';
$string['solved']='Σωστό';
$string['time']='Χρόνος';
