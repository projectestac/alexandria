<?php // $Id: questions_form.php,v 1.21.2.4 2009/06/07 12:07:31 joseph_rezeau Exp $
/**
* print the form to add or edit a questionnaire-instance
*
* @version $Id: questions_form.php,v 1.21.2.4 2009/06/07 12:07:31 joseph_rezeau Exp $
...
class questionnaire_edit_question_form extends moodleform {
    ...
    function definition() {
        global $CFG, $COURSE, $ESPCONFIG, $questionnaire, $question, $QUESTIONNAIRE_REALMS, $SESSION;
