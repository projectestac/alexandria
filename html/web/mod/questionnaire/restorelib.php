<?php //$Id: restorelib.php,v 1.12.2.6 2009/02/07 22:03:30 joseph_rezeau Exp $
    ...
    function questionnaire_restore_mods($mod, $restore) {
        ...
        /// JR added resp_view and resume to backup and restore
            ...
            //XTEC ***************** MODIFICAT - Els qüestionaris PHPEsp sempre estan disponibles
            //2010.02.03 @fcasanel
        ...
        /// to gracefully import questionnaires with data authored in moodle 1.8    
            if (array_key_exists('GRADE', $info)) {
        ...
        /// Set the owner to the new course id.
            ...
            $survey->public = strtolower(backup_todb($surveydata['PUBLIC']['0']['#']));
    ...
    function questionnaire_restore_questions($sid, &$questiondata) {
        ...
        if (is_array($questiondata)) {
            foreach ($questiondata as $questrec) {
                ...
                $newquest->public = strtolower(backup_todb($questrec['#']['PUBLIC']['0']['#']));
