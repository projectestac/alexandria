...
function convert_urls_into_links(&$text) {
    ...
    //&lt;a href="blah"&gt;
    //&lt;a href="blah">
    //XTEC ************** MODIFICAT - Ignore URLs in "embed" or "param" tags
    //2011.01.03 @fcasanel
    $filterignoretagsopen = array('<a\s[^>]+?>', '<embed\s[^>]+?>', '<param\s[^>]+?>');
...
/// Get a list of all the files we want to include
    ...
    //XTEC ************ ELIMINAT - To load styles.php the theme has activated modsheets config param
    //2010.07.07
