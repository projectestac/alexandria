<?php // $Id: accesslib.php,v 1.421.2.110 2011/01/12 09:57:33 moodlerobot Exp $
...
function create_context($contextlevel, $instanceid) {
    ...
    switch ($contextlevel) {
        ...
        case CONTEXT_COURSE:
			//XTEC ************ MODIFICAT - Added simple quotation to solve the problems with the upgrade to 1.9.9
			//2010.06.30
            $sql = "SELECT ctx.path, ctx.depth
                    FROM {$CFG->prefix}context           ctx
