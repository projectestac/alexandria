...
class auth_plugin_ldap extends auth_plugin_base {
    ...
    //XTEC ************ AFEGIT - Don't allow acces for generic school users
	//2010.08.05
    /**
     * Returns true if the username is a school username (format: siiiiiii, where s=string and i=integer)
     *
     * @param string $username The username
     *
     * @return bool School id checking success or failure.
     */
    function is_school_username($username){
        return (is_string(substr($username,0,1)) && $this->is_int_val(substr($username,1)));
    }
    ...
    function user_login($username, $password) {
        ...
        //XTEC ************ AFEGIT - Don't allow acces for generic school users
        if ($this->is_school_username($username)){
            print_error('auth_schoolusernotallowed','auth');
            return false;                  // Don't allow acces for generic school users
        }
        //************ FI
	...
	//************ FI
        if ($ldapconnection) {
            ...
            //XTEC ************ AFEGIT - It's necessary to make work XTEC LDAP
