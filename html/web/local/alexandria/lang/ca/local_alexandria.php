...
$string['summaryfieldid'] = 'Camp de la descripció';
...
$string['configsummaryfieldid'] = 'Camp de la base de dades que conté la descripció';
$string['configcreatorfieldid'] = 'Camp de la base de dades que conté l\'autor';
$string['configcategoryfieldid'] = 'Camp de la base de dades que conté la categoria';
$string['configurlfieldid'] = 'Camp de la base de dades que conté la URL';
$string['configlicensefieldid'] = 'Camp de la base de dades que conté la llicència';
$string['configcreationdatefieldid'] = 'Camp de la base de dades que conté la data de creació';
...
$string['downloads'] = '<span id="download_counter">{$a}</span> descàrregues';
$string['last_download'] = 'Última descàrrega: ';
$string['total_downloads'] = 'Descàrregues totals: ';
$string['preview_resource'] = 'Previsualitza el recurs';
$string['preview_hide'] = 'Amaga la previsualització';
$string['file_notavalaible'] = 'El fitxer no està disponible';
