...
if($parents){
    ...
    foreach($parents_pos_array as $parent=>$pos){
        if ($top_menu_content[$parent]['name']){
            ...
            $top_menu .= "<input type='text' id='name_item_".$parent."' value='".$top_menu_content[$parent]['name']."' disabled='true' size='15'/>";
            $top_menu .= '<b> '.get_string('item_url','theme_config').': </b>';
            $top_menu .= "<input type='text' id='url_item_".$parent."' value='".$top_menu_content[$parent]['url']."' disabled='true' size='40'/>";
            ...
            if($children){
                ...
                foreach ($children_pos_array as $child=>$pos){
                    if ($top_menu_content[$child]['name']){
                        ...
                        $top_menu .= "<input type='text' id='name_item_".$child."' value='".$top_menu_content[$child]['name']."' disabled='true' size='15'/>";
                        $top_menu .= ' '.get_string('item_url','theme_config').': ';
                        $top_menu .= "<input type='text' id='url_item_".$child."' value='".$top_menu_content[$child]['url']."' disabled='true' size='40'/>";
