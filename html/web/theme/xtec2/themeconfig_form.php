...
class themeconfig_form extends moodleform {
    ...
    function definition() {
		...
		$mform->setDefault('theme_color4', isset($CFG->theme_color4) ? $CFG->theme_color4: '#59110A');
			...
			$mform->setDefault('pers_style', $output);
                ...
                ?>
                    ...
                    function editItem(item){
                        ...
                        YAHOO.util.Connect.asyncRequest('POST','top_menu/edit_item.php',{success:editItemResponse,failure:functionFailure},'item='+item+'&name='+name+'&url='+url);
                    }
                    ...
                    function addSon(item){
                        ...
                        if(name==''){
                            ...
                            YAHOO.util.Connect.asyncRequest('POST','top_menu/add_son.php',{success:addSonResponse,failure:functionFailure},'item='+item+'&name='+name+'&url='+url);
                        }
                    }
