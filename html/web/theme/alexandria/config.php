...
$THEME->sheets = array('aardvark_layout','aardvark_color','aardvark_fonts', 'aardvark_topmenu', 'aardvark_default');
if(file_exists($CFG->dataroot.'/1/theme/styles_layout.css')){
   array_push($THEME->sheets, '../../../../moodledata/1/theme/styles_layout');
}
if (file_exists($CFG->dataroot.'/1/theme/styles_fonts.css')){
   array_push($THEME->sheets, '../../../../moodledata/1/theme/styles_fonts');    
} 
if (file_exists($CFG->dataroot.'/1/theme/styles_color.css')){
	array_push($THEME->sheets, '../../../../moodledata/1/theme/styles_color');
}
