...
class block_admin extends block_list {
    ...
    function get_content() {
		...
		//XTEC ************ MODIFICAT - Admin block showed only to users who can update the course
		//2010.08.05 
		if (!has_capability('moodle/course:view', $context) || !has_capability('moodle/course:update', $context)) {  // Just return
            return $this->content;
        }
		//************ ORIGINAL
		/*
