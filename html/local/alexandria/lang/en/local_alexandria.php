...
$string['downloads'] = '<span id="download_counter">{$a}</span> downloads';
$string['last_download'] = 'Last download: ';
$string['total_downloads'] = 'Total downloads: ';
$string['preview_resource'] = 'Preview resource';
$string['preview_hide'] = 'Hide preview';
$string['file_notavalaible'] = 'File is not avalaible';
